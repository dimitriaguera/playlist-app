      ...
      if (playlistIsPlaying) {
        ...
        return (
          <button
            ...
            onClick={this.handlerPlayPlaylist}
            className="btn btn-icon big"
          >
    ...
    return (
      <div className="info-panel-playlist">
        <div className="info-panel-playlist-img">
          <Img title={title} src={''} defaultSrc={defaultCover} />
        </div>
        <div className="info-panel-playlist-meta">
          ...
          {item.tracks && (
            <span className="length">{item.tracks.length} tracks</span>
          )}
        </div>
        <div className="info-panel-playlist-menu">{getButton()}</div>
      </div>
    );
  }
}
