          ...
          <div className="audioBar-wrapper">
            ...
            <div className="audioBar-coll3 audioBar-menu-wrap">
              <div className="audioBar-menu">
                <button
                  title="See path of playing song"
                  aria-label="Open breadcrumb"
                  onClick={this.onOpenBreadHandler}
                >
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    nextTracks: (item, callback) => dispatch(callback(item)),
    updatePlayingList: item => dispatch(updatePlaylistToPlay(item))
  };
};

const AudioBarContainer = connect(mapStateToProps, mapDispatchToProps)(AudioBar);
