    ...
    const leftBtn = () => {
      if (pl) {
        ...
        return (
          ...
          >
            <i aria-hidden="true" className="icon icon-skip-back" />
          </button>
        );
      }
      return (
        <button aria-label="Previous" disabled="true" className="btn">
          <i aria-hidden="true" className="icon icon-skip-back" />
        </button>
      );
    };
    ...
    const rightBtn = () => {
      if (pl) {
        ...
        return (
          ...
          >
            <i aria-hidden="true" className="icon icon-skip-forward" />
          </button>
        );
      }
      return (
        <button aria-label="Next" disabled="true" className="btn">
          <i aria-hidden="true" className="icon icon-skip-forward" />
        </button>
      );
    };
