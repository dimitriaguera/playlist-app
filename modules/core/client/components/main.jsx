    ...
    return (
      <div id='side-and-main-container'>
        ...
        <main id="main-content">
          <button id="btn-nav" ref={domElmt => this.domElmt = domElmt} className="nav-button large-hidden medium-hidden" onClick={(e) => this.clickBurger(e)} type="button" role="button" aria-label="open/close navigation"><i aria-hidden="true"></i></button>
          <Switch>
            {routes}
